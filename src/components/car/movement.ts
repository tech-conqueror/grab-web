...
// Function to get the next coordinate index in the path
...
// Function to advance a coordinate toward the next position with an increment
...
export const countTurns = (section: [number, number][]): number => {
  let count = 0;
